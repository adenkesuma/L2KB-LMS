...
const ParticipantAchievementDetail = () => {
    ...
    return (
      <div className='min-h-screen p-12'>
            <h1 className="font-bold text-[38px] text-gray-800">Pencapaian <span className="capitalize">{params.detail}</span></h1>
                        ...
                        <table className="min-w-full text-left text-sm font-light">
                          <thead className="border-b font-medium text-green text-base">
                            <tr>
                              ...
                              <th scope="col" className="px-6 py-4">Program Pembelajaran</th>
                              <th scope="col" className="px-6 py-4">Sertifikat</th>
                            </tr>
                          </thead>
