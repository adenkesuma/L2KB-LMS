...
const Login = () => {
  return (
    <main className='h-[100vh] w-full flex flex-col items-center justify-center'>
      ...
      <div className="mx-auto w-[60%] flex flex-col gap-6">
      ...
      <button className="mt-12 text-center w-[300px] text-white font-medium p-2 rounded-xl bg-green">
        Masuk
      </button>

      <p className='text-sm mt-6'>
        Belum Punya Akun ? <Link href="/register" className='text-green font-semibold'> Daftar Sekarang</Link>
      </p>
    </main>
  )
}
