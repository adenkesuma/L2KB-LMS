...
const UploadFacilities = ({ adminAK } : { adminAK: string | null | undefined }) => {
    ...
    const handleImageUpload = async (e: any) => {
        ...
        if (selectedImage) {
            ...
            formData.append("facility_image", selectedImage);

            try {
                const response = await axios.post(
                    `${process.env.NEXT_PUBLIC_P2KB_API}/facility/upload`,
                    formData,
                    {
                        headers: {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="mb-6 font-bold text-xl">Upload Fasilitas</h2>
                {selectedImage ? (
                    <Image 
