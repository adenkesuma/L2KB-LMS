...
const ActivateUser = () => {
  return (
    <div className="min-h-screen p-12">
      <h1 className="font-bold text-[38px] text-gray-800">Aktivasi Pengguna</h1>
                ...
                <table className="min-w-full text-left text-sm font-light">
                  ...
                  <tbody className="text-gray-600 text-sm font-normal">
                    <tr className="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:hover:bg-gray-100">
                      ...
                      <td className="whitespace-nowrap px-6 py-4">
                        <span className="text-red-500 bg-red-100 rounded-md p-2 text-sm">
                          Belum di Aktivasi
                        </span>
                      </td>
                      <td className="whitespace-nowrap px-6 py-4">
                        <Link
                          href="/admin/activate-user/abdul"
