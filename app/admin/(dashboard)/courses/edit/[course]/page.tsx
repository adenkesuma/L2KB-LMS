  ...
  return (
    <div className="min-h-screen p-12">
      <div className="flex justify-between items-center">
        <h1 className="font-bold text-[38px] text-gray-800">
          Edit Pelatihan Pelatihan
        </h1>
      </div>
      ...
      <div className="flex items-start gap-8">
        ...
        <aside className="w-1/4 rounded-xl border border-gray-100 mt-8 bg-white p-8 flex flex-col gap-6">
          <h2 className="mb-2 font-semibold text-[22px] text-gray-800">
            Terbitkan
          </h2>
          ...
          <div className="p-4 rounded-xl bg-gray-100 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="mb-2 font-medium text-lg text-gray-800">
                Jadwal Pendaftaran
              </h3>
