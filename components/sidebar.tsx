      ...
      <>
          {pathname === "/admin" ? (
              ...
              <>
                    ...
                    <div className={`bg-green hidden p-3 xl:p-6 md:w-[10%] lg:w-[7%] xl:w-[18%] 2xl:w-[14%] md:flex flex-col justify-center sm:justify-between h-screen md:sticky left-0 top-0 bottom-0 ${showNavigate ? "z-50" : ""} `}>
                        <div>
                        ...
                        <button className="mt-6 text-white py-3 delay-75 duration-75 hover:bg-opacity-green flex justify-center items-center gap-4 rounded-lg">
                            <Image 
                                ...
                                className="w-[14px]"
                            />
                            <span className="xl:block text-xs md:hidden xl:text-sm">Logout</span>
                        </button>
                    </div>

                    {/* phone navigate */}
                    {showNavigate ? (
                        <div className={`bg-green p-3 absolute right-0 flex flex-col justify-center sm:justify-between h-screen left-0 top-0 bottom-0 ${showNavigate ? "z-50" : ""} `}>
                            <div>
                                <figure className="mx-auto flex justify-center">
                                    <Image 
                                            src={Logo}
