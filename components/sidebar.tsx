    ...
    return (
      <>
          {pathname === "/admin" ? (
              ...
              <div>
                  <div className={`bg-green absolute right-0 p-3 xl:p-6 md:w-[10%] lg:w-[7%] xl:w-[18%] 2xl:w-[14%] md:flex flex-col justify-between  h-screen md:sticky left-0 top-0 bottom-0 ${showNavigate ? "z-50" : ""}`}>
                      <div>
                      ...
                      <button className="text-white py-3 delay-75 duration-75 hover:bg-opacity-green flex justify-center items-center gap-4 rounded-lg">
                          <Image 
                              ...
                              className="w-4"
                          />
                          <span className="xl:block hidden text-xs 2xl:text-sm">Logout</span>
                      </button>
                  </div>
